...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C007211" ON "AUTO_USER" ("ID")
--------------------------------------------------------
--  DDL for Index SYS_C007213
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYS_C007213" ON "HIST_USER_AUTHORITY" ("ID")
--------------------------------------------------------
--  DDL for Index SYS_C007212
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYS_C007212" ON "NM_AUTHORITY" ("ID")
--------------------------------------------------------
